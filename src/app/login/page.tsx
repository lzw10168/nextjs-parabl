    ...
    <div className="flex min-h-screen w-full flex-col lg:flex-row">
      ...
      <div className="relative hidden w-full bg-gray-900 lg:block lg:w-1/2">
        ...
        <div className="absolute inset-0 bg-black/30">
          ...
          <div className="absolute left-0 bottom-1/2 p-24">
            <h1 className="mb-6 text-6xl font-bold leading-tight text-white">
              Welcome Parabl
            </h1>
            <p className="text-2xl text-white">
              Our open-source repositories are now available. API keys for hosted solutions are coming soon.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center bg-white p-8 lg:w-1/2 rounded-l-3xl z-10" style={{
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 flex flex-row space-x-4">
            <button className="flex w-full items-center justify-center rounded-md border border-gray-300 px-1 py-2 transition text-gray-900 hover:bg-gray-50">
              <Image
          ...
          <p className="mt-6 text-left text-gray-600">
            ...
            <Link href="/login/signin" className="font-medium text-cyan-500 hover:text-cyan-700">
              Log in
            </Link>
          </p>
        </div>
